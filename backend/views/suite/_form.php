...
<div class="suite-form">
    ...
    <?php echo $form->field($model, 'suite_id')->textInput(['maxlength' => true]) ?>

    <?php echo $form->field($model, 'token')->textInput(['maxlength' => true]) ?>

    <?php echo $form->field($model, 'encodingAESKey')->textInput(['maxlength' => true]) ?>

    <?php echo $form->field($model, 'suite_secret')->textInput(['maxlength' => true]) ?>

    <?php echo $form->field($model, 'suite_ticket')->textInput(['maxlength' => true]) ?>

    <?php //echo $form->field($model, 'auth_code')->textInput(['maxlength' => true]) ?>

    <?php //echo $form->field($model, 'permanent_code')->textInput(['maxlength' => true]) ?>

    <?php //echo $form->field($model, 'accessToken')->textInput(['maxlength' => true]) ?>

    <?php //echo $form->field($model, 'accessToken_expiresIn')->textInput() ?>
