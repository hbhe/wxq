...
<div class="corp-form">
    ...
    <?php echo $form->field($model, 'corp_id')->textInput(['maxlength' => true]) ?>

    <?php echo $form->field($model, 'corp_name')->textInput(['maxlength' => true]) ?>

    <?php echo $form->field($model, 'corp_type')->textInput(['maxlength' => true]) ?>

    <?php echo $form->field($model, 'corp_round_logo_url')->textInput(['maxlength' => true]) ?>

    <?php echo $form->field($model, 'corp_square_logo_url')->textInput(['maxlength' => true]) ?>

    <?php echo $form->field($model, 'corp_user_max')->textInput() ?>

    <?php echo $form->field($model, 'corp_agent_max')->textInput() ?>

    <?php echo $form->field($model, 'corp_wxqrcode')->textInput(['maxlength' => true]) ?>

    <?php echo $form->field($model, 'corp_full_name')->textInput(['maxlength' => true]) ?>

    <?php echo $form->field($model, 'subject_type')->textInput() ?>

    <?php echo $form->field($model, 'userid')->textInput(['maxlength' => true]) ?>
