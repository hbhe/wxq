...
class NearestOfficeBehavior extends Behavior {
    ...
    public function locationSelector($event) {
        ...
        //yii::error([$location_X, $location_Y, $scale, $label, $message]);
        if ($msgType == 'event' && $eventkey == 'sjdxfw') {
            ...
            $news6 = new News(['title' => '第六张图','description'=>'第六张图描述','url'=>'www.baidu.com','image'=>'http://admin.buy027.com/image-cache/c7/c7e2c4_1490153860-1-.jpg']);
            $news7 = new News(['title' => '第七张图','description'=>'第七张图描述','url'=>'www.baidu.com','image'=>'http://admin.buy027.com/image-cache/c7/c7e2c4_1490153860-1-.jpg']);
            $news8 = new News(['title' => '第八张图','description'=>'第八张图描述','url'=>'www.baidu.com','image'=>'http://admin.buy027.com/image-cache/c7/c7e2c4_1490153860-1-.jpg']);
            $news9 = new News(['title' => '第九张图','description'=>'第九张图描述','url'=>'www.baidu.com','image'=>'http://admin.buy027.com/image-cache/c7/c7e2c4_1490153860-1-.jpg']); */
