    ...
    <div class="page__bd">
        ...
        <div class="weui-cells">
            ...
            <a class="weui-cell weui-cell_access" href="<?php echo Url::to(['list', 'is_revenue' => 1]); ?>">
                <div class="weui-cell__hd"><img src="<?php echo $bundle->baseUrl . '/img/self/u2358.png'; ?>" alt="" style="width:20px;margin-right:5px;display:block"></div>
                <div class="weui-cell__bd">
                    <p>总酬金x</p>
                </div>
                <div class="weui-cell__ft">￥ <?php echo '123'; ?></div>
           </a>

            <a class="weui-cell weui-cell_access" href="<?php echo Url::to(['list', 'is_revenue' => 0]); ?>">
                <div class="weui-cell__hd">
                <img src="<?php echo $bundle->baseUrl . '/img/self/u2358.png'; ?>" alt="" style="width:20px;margin-right:5px;display:block">
                </div>
                <div class="weui-cell__bd">
                    <p>已领酬金</p>
                </div>
            ...
            <div class="weui-cell">
                ...
                <div class="weui-cell__ft">￥<?php echo '123' / 100; ?></div>
            </div>
        </div>
        ...
        <div class="weui-cells">
            <a class="weui-cell weui-cell_access" href="<?php echo Url::to(['about']); ?>">
                <div class="weui-cell__hd"><img src="<?php echo $bundle->baseUrl . '/img/self/u2364.png'; ?>" alt="" style="width:20px;margin-right:5px;display:block"></div>
                <div class="weui-cell__bd">
                    <p>关于红包</p>
                </div>
