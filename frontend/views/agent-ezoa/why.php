...
<div class="page">
	...
	<div class="weui-cells">
		<article class="weui-article" style="color: #999999;font-size:14px;background: #ffffff none repeat scroll 0 0;">
			<h2 style="color:#333333">活动奖励x</h2>
			<p>每发展一个粉丝0.5元，粉丝达到10个或以上用户享有核酬资格</p>
	...
	<div class="weui-cells">
		<article class="weui-article" style="color: #999999;font-size:14px;background: #ffffff none repeat scroll 0 0;">
			...
			<p style="padding-bottom:10px;">1. 参与活动的用户需要关注微信公众号，并且注册会员</p>
			<p>2. 会员发展的粉丝中湖北省内用户计入酬金体系，其他异省用户只统计到总粉丝数中。</p>
			<p>3. 粉丝多次重复关注的，系统默认只统计一次。</p>
			<p>4. 每周三为酬金发放日，酬金通过官微以红包形式发放，红包24小时未领取，系统将会自动退回，未领取酬金累计到下期发放。</p>
